<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <form action="{{ route('business.update') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <div class="mt-6">
                        ...
                        >{{ old('description', $business->description) }}</flux:textarea>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            <flux:input 
                                ...
                                type="number"
                                min="1"
                                :value="old('delivery_period_minutes', $business->delivery_period_minutes)"
                                required
